  ...
  sapatamu: {
    basic: {
      ...
      features: [
        ...
        { text: 'Subdomain rekavia.com', included: false },
    ...
    pro: {
      ...
      features: [
        ...
        { text: 'Subdomain rekavia.com', included: true },
...
export const WEDDING_THEMES: WeddingThemePreset[] = [
  {
    ...
    previewImage: '/sapatamu-themes/malay-ethnic-red-ruby/original/pictures/picture_17393765661722ej1do.png',
    primaryColor: '#4a1a1f',
  ...
  ...PUBLIC_SOURCE_THEME_PRESETS.slice(0, 1),
  {
    ...
    previewImage: '/sapatamu-themes/batak-ethnic-maroon-mistyrose/original/pictures/picture_1739377539664wswbzef.png',
    primaryColor: '#7b0f24',
