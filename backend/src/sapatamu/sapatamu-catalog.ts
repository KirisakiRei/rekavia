...
export const SAPATAMU_THEME_SEEDS: ThemeSeed[] = [
  {
    ...
    previewImageUrl: '/sapatamu-themes/malay-ethnic-red-ruby/original/pictures/picture_17393765661722ej1do.png',
    metadata: {
      group: 'Budaya',
  ...
  additionalSourceThemeSeed('cheerfulness-floralwhite'),
  {
    ...
    previewImageUrl: '/sapatamu-themes/batak-ethnic-maroon-mistyrose/original/pictures/picture_1739377539664wswbzef.png',
    metadata: {
      group: 'Budaya',
      tierCategory: 'premium',
      supportsDedicatedRenderer: true,
...
export const SAPATAMU_TEMPLATE_ASSET_SEEDS: TemplateAssetSeed[] = [
  {
    ...
    url: '/sapatamu-themes/malay-ethnic-red-ruby/original/pictures/picture_17393765661722ej1do.png',
    fileName: 'picture_17393765661722ej1do.png',
    sortOrder: 1,
  ...
  },
  {
    ...
    assetType: 'preview',
    assetKey: 'cover.preview',
    url: '/sapatamu-themes/batak-ethnic-maroon-mistyrose/original/pictures/picture_1739377539664wswbzef.png',
    fileName: 'picture_1739377539664wswbzef.png',
    sortOrder: 1,
    metadata: { slot: 'cover', enabled: true },
  },
  {
